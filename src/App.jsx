          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <article className="flex-1 text-center md:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                <a href="/gamedev-portfolio/public/resume.pdf" target="_blank" className="px-8 py-3 rounded-full bg-[#ff0055] text-white font-bold uppercase tracking-widest hover:bg-[#d40047] hover:-translate-y-1 hover:shadow-[0_0_20px_rgba(255,0,85,0.4)] transition-all duration-300 flex items-center justify-center gap-2">
